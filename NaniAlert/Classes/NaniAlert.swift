...
open class NaniAlert: UIView {
    ...
    open func setAttribute() {
        ...
        confirmButton?.setTitle(confirmText ?? "확인", for: .normal)
    ...
    open func show(in superView: UIView) {
        ...
        guard let contentView, let titleLabel, let lineView, let confirmButton else { return }
